    ...
    return (
        <>
            <Navbar className='bg-transparent Header' expand="md">
                <div className='container flex items-center justify-between w-full px-4 mx-auto my-3 navBar'>
                    <NavbarBrand href="/">
                        <div className=''>
                            <img
                                alt='logo'
...

                    {
                        cookies.user?.userType !== "admin" ?
                            ...
                            <div className='hidden gap-4 text-sm font-bold uppercase navMenu md:flex'>
                                ...
                                <NavLink to={'/admin-product'} className="text-gray-800 hover:text-gray-500 hover:underline active:text-gray-950 no-underline">Product</NavLink>

                                <NavLink to={'/admin-dashboard'} className="flex items-center gap-1 text-gray-800 hover:text-gray-500 hover:underline active:text-gray-950 no-underline">Dashboard </NavLink>

                                <NavLink to={'/admin-order'} className="text-gray-800 hover:text-gray-500 hover:underline active:text-gray-950 no-underline">Order</NavLink>

                                <NavLink to={'/admin-user'} className="flex items-center gap-1 text-gray-800 hover:text-gray-500 hover:underline active:text-gray-950 no-underline">User</NavLink>
                            </div>
                    }
